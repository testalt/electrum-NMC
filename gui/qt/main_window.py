...
from electrum_NMC.util import format_satoshis
...
class ElectrumWindow(QMainWindow):
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Electrum-NMC ' + self.wallet.electrum_version + '  -  ' + self.wallet.storage.path
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("http://electrum-alt.org"))
        help_menu.addSeparator()
        help_menu.addAction(_("&Documentation"), lambda: webbrowser.open("http://electrum-alt.org/documentation.html")).setShortcut(QKeySequence.HelpContents)
    ...
    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-NMC - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/ixcoin123/electrum-nmc/issues\">https://github.com/ixcoin123/electrum-nmc/issues</a>")
    ...
    def settings_dialog(self):
        ...
        def on_unit(x):
            ...
            elif unit_result == 'mNMC':
                self.decimal_point = 5
            elif unit_result == 'nbits':

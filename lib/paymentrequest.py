...
REQUEST_HEADERS = {'Accept': 'application/bitcoin-paymentrequest', 'User-Agent': 'Electrum-NMC'}
ACK_HEADERS = {'Content-Type':'application/bitcoin-payment','Accept':'application/bitcoin-paymentack','User-Agent':'Electrum-NMC'}
...
def load_certificates():
    try:
        ...
        print "ca-bundle.crt file should be placed in ~/.electrum-nmc/ca/ca-bundle.crt"
...
class PaymentRequest:
    ...
    def send_ack(self, raw_tx, refund_addr):
        ...
        paymnt.memo = "Paid using Electrum-NMC"

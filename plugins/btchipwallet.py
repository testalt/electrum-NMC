...
import electrum_NMC
from electrum_NMC_gui.qt.password_dialog import make_password_dialog, run_password_dialog
from electrum_NMC_gui.qt.util import ok_cancel_buttons
from electrum_NMC.account import BIP32_Account
from electrum_NMC.bitcoin import EncodeBase58Check, DecodeBase58Check, public_key_to_bc_address, bc_address_to_hash_160
from electrum_NMC.i18n import _
from electrum_NMC.plugins import BasePlugin, hook
from electrum_NMC.transaction import deserialize
from electrum_NMC.wallet import NewWallet
...
class Plugin(BasePlugin):
    ...
    def __init__(self, gui, name):
        ...
        self.wallet = None        
        electrum_NMC.wallet.wallet_types.append(('hardware', 'btchip', _("BTChip wallet"), BTChipWallet))
